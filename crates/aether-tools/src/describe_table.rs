...
pub struct AetherDescribeTableInput {
...
pub struct AetherDescribeTableTool {
    pub workspace: Arc<AetherWorkspace>,
}

#[async_trait]
impl ToolFunction for AetherDescribeTableTool {
    type Input = AetherDescribeTableInput;
