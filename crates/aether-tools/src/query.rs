//! Read-side tool: preview table rows via DataFusion SQL on the shared workspace.
//!
...
pub struct AetherPreviewTableInput {
...
pub struct AetherPreviewTableTool {
    pub workspace: Arc<AetherWorkspace>,
}

#[async_trait]
impl ToolFunction for AetherPreviewTableTool {
    type Input = AetherPreviewTableInput;
